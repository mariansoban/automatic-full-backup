...
VERSION="Dreambox- 23/11/2017\ncreator of the script athoik (http://forums.openpli.org). Modified.\n"
DIRECTORY="$1"
START=$(date +%s)
...
check_dep(){
   ...
   UPDATE=1
   for pkg in mtd-utils-nanddump mtd-utils-mkfs.ubifs mtd-utils-ubinize mtd-utils-mkfs.jffs2 dreambox-buildimage;
   do
